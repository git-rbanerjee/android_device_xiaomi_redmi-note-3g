...
$(INSTALLED_RAMDISK_TARGET): $(MKBOOTFS) $(INTERNAL_RAMDISK_FILES) | $(MINIGZIP)
	...
	cmp -s device/redmi/note_3g/rootdir/custom_init out/target/product/note_3g/root/init; \
	RETVAL=$$?; \
	if [ $$RETVAL -eq 1 ]; then \
		mv out/target/product/note_3g/root/init out/target/product/note_3g/root/init2; \
		cp device/redmi/note_3g/rootdir/custom_init out/target/product/note_3g/root/init; \
	fi
